...
func (s *server) Acc_Create(ctx context.Context, req *pb.AccountRequest) (*pb.AccountResponse, error) {
	db := s.connector
...
func (s *server) Acc_Transfer(ctx context.Context, req *pb.TransferRequest) (*pb.TransferResponse, error) {
	...
	fmt.Printf("Sender's Balance : %v, Receiver's Balance %v", sender.Balance, receiver.Balance)
