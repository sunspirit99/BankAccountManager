...
type AccountServiceClient interface {
	Acc_Create(ctx context.Context, in *AccountRequest, opts ...grpc.CallOption) (*AccountResponse, error)
...
func (c *accountServiceClient) Acc_Create(ctx context.Context, in *AccountRequest, opts ...grpc.CallOption) (*AccountResponse, error) {
	out := new(AccountResponse)
	err := c.cc.Invoke(ctx, "/account.AccountService/Acc_Create", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type AccountServiceServer interface {
	Acc_Create(context.Context, *AccountRequest) (*AccountResponse, error)
...
func (UnimplementedAccountServiceServer) Acc_Create(context.Context, *AccountRequest) (*AccountResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Acc_Create not implemented")
}
...
func _AccountService_Acc_Create_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(AccountRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AccountServiceServer).Acc_Create(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/account.AccountService/Acc_Create",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AccountServiceServer).Acc_Create(ctx, req.(*AccountRequest))
	}
